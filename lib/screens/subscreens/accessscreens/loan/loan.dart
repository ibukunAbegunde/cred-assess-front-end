...
import 'package:cred_assess/screens/subscreens/offers/loan/loanedit1.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                            'Get a great loan deal that could save you thousands. ',textAlign: TextAlign.center, style: Theme.of(context).textTheme.bodyLarge!.copyWith(color:TColors.white, fontWeight: FontWeight.w700, fontSize: 18)),
                      ),
                      const SizedBox(height: 1),
                      Expanded(
                        child: Center(
                          child:  Image.asset(
                            'images/loann.png',width: 300,
                            // height: 300,
                          ),
                        ),
                      ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Text(
                          'Compare loan rates from over 90 trusted lenders!', style: Theme.of(context).textTheme.bodySmall!.copyWith(fontWeight: FontWeight.w700, fontSize: 16)),
                      const SizedBox(
                        height: TSizes.defaultSpace,
                      ),
                      tilesComponent(icon:'images/bag.png', title: 'Student Loan', subtitle: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, ', Ontap:(){
                        Navigation.push(loanEditOne(), context);
                      },),
                      Divider(),
