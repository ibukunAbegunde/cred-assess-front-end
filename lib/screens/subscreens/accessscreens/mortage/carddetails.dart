...
class mortageCardDetails extends StatefulWidget {
  final String typi;

  const mortageCardDetails({super.key, required this.typi});

  @override
  State<mortageCardDetails> createState() => _mortageCardDetailsState();
}

class _mortageCardDetailsState extends State<mortageCardDetails> {
